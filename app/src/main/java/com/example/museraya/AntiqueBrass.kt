...
class AntiqueBrass : Fragment() {
    ...
    // --- Variables for Plane Renderer Timer ---
    ...
    override fun onCreateView(
        ...
        // !! IMPORTANT !! Ensure this layout and the IDs below are correct for AntiqueBrass
        val view = inflater.inflate(R.layout.fragment_woodcutterar, container, false) // Or R.layout.fragment_antiquebrass_ar

        arSceneView = view.findViewById(R.id.arSceneViewWoodCutter) // e.g., R.id.arSceneViewAntiqueBrass
        placeModelButton = view.findViewById(R.id.btnPlaceModelWoodCutter) // e.g., R.id.btnPlaceModelAntiqueBrass
        btnInfo = view.findViewById(R.id.btnInfoWoodcutter) // e.g., R.id.btnInfoAntiqueBrass
        btnHelp = view.findViewById(R.id.btnHelpWoodcutter) // e.g., R.id.btnHelpAntiqueBrass
        tvInstructions = view.findViewById(R.id.tvInstructionsWoodcutter) // e.g., R.id.tvInstructionsAntiqueBrass
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Reset timer flag on view creation
    ...
    // --- REVISED Info Dialog Method ---
    private fun showInfoDialog() {
        AlertDialog.Builder(requireContext())
            .setTitle(R.string.Antique_title) // Use correct string ID
            .setMessage(R.string.Antique_Message) // Use correct string ID
            .setPositiveButton(R.string.dialog_ok, null) // Use correct string ID for OK
            .show()
    }
    // --- END REVISION ---
            ...
            anchorNode = AnchorNode(arSceneView.engine, anchor).apply {
                ...
                lifecycleScope.launch {
                    val modelInstance = arSceneView.modelLoader.loadModelInstance(
                        "file:///android_asset/models/brasstelescope.glb" // Verify model path
                    )
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        interactionInstructionJob?.cancel()
        // Cancel the plane renderer timer job
