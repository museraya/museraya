...
class NagraOpen : Fragment() {
    ...
    override fun onCreateView(
        ...
        // !! IMPORTANT !! Ensure this layout and the IDs below are correct for NagraOpen
        val view = inflater.inflate(R.layout.fragment_woodcutterar, container, false) // Or R.layout.fragment_nagraopen_ar

        arSceneView = view.findViewById(R.id.arSceneViewWoodCutter) // e.g., R.id.arSceneViewNagraOpen
        placeModelButton = view.findViewById(R.id.btnPlaceModelWoodCutter) // e.g., R.id.btnPlaceModelNagraOpen
        btnInfo = view.findViewById(R.id.btnInfoWoodcutter) // e.g., R.id.btnInfoNagraOpen
        btnHelp = view.findViewById(R.id.btnHelpWoodcutter) // e.g., R.id.btnHelpNagraOpen
        tvInstructions = view.findViewById(R.id.tvInstructionsWoodcutter) // e.g., R.id.tvInstructionsNagraOpen
    ...
    private fun showInfoDialog() {
        AlertDialog.Builder(requireContext())
            .setTitle(R.string.Nagra_title) // Use correct string ID
            .setMessage(R.string.Nagra_message) // Use correct string ID
            ...
            anchorNode = AnchorNode(arSceneView.engine, anchor).apply {
                ...
                lifecycleScope.launch {
                    val modelInstance = arSceneView.modelLoader.loadModelInstance(
                        "file:///android_asset/models/fieldrecorder.glb" // Verify model path
                    )
