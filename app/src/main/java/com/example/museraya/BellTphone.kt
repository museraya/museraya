...
class BellTphone : Fragment() {
    ...
    override fun onCreateView(
        ...
        // !! IMPORTANT !! Ensure this layout and the IDs below are correct for BellTphone
        val view = inflater.inflate(R.layout.fragment_woodcutterar, container, false) // Or R.layout.fragment_belltphone_ar

        arSceneView = view.findViewById(R.id.arSceneViewWoodCutter) // e.g., R.id.arSceneViewBellTphone
        placeModelButton = view.findViewById(R.id.btnPlaceModelWoodCutter) // e.g., R.id.btnPlaceModelBellTphone
        btnInfo = view.findViewById(R.id.btnInfoWoodcutter) // e.g., R.id.btnInfoBellTphone
        btnHelp = view.findViewById(R.id.btnHelpWoodcutter) // e.g., R.id.btnHelpBellTphone
        tvInstructions = view.findViewById(R.id.tvInstructionsWoodcutter) // e.g., R.id.tvInstructionsBellTphone
    ...
    private fun showInfoDialog() {
        AlertDialog.Builder(requireContext())
            .setTitle(R.string.Bell_title) // Use correct string ID
            .setMessage(R.string.Bell_message) // Use correct string ID
            ...
            anchorNode = AnchorNode(arSceneView.engine, anchor).apply {
                ...
                lifecycleScope.launch {
                    val modelInstance = arSceneView.modelLoader.loadModelInstance(
                        "file:///android_asset/models/telephone.glb" // Verify model path
                    )
